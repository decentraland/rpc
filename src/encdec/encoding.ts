 ...
 * @param {number} len
 */
const verifyLen = (encoder: Encoder, len: number) => {
 ...
 */
export const writeVarString = (encoder: Encoder, str: string) => {
 ...
 * @param {bigint} num
 */
export const writeBigInt64 = (encoder: Encoder, num: bigint) =>
 ...
 * @param {bigint} num
 */
export const writeBigUint64 = (encoder: Encoder, num: bigint) =>
...
export const writeAny = (
  encoder: Encoder,
  data: undefined | null | number | bigint | boolean | string | { [s: string]: any } | Array<any> | Uint8Array
) => {
  switch (typeof data) {
    case "string":
      // TYPE 119: STRING
