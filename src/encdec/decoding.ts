 ...
 * @return {Uint8Array}
 */
export const readTailAsUint8Array = (decoder: Decoder): Uint8Array =>
 ...
 * @return {number} An unsigned integer.
 */
export const peekUint16 = (decoder: Decoder): number => decoder.arr[decoder.pos] + (decoder.arr[decoder.pos + 1] << 8)
 ...
 */
export const readVarString = (decoder: Decoder): string => {
  ...
  if (remainingLen === 0) {
    ...
    if (--remainingLen < 100) {
      ...
      while (remainingLen > 0) {
        ...
        encodedString += String.fromCodePoint.apply(null, /** @type {any} */ bytes as any)
 ...
 * @param {Decoder} decoder
 */
export const readBigUint64 = (decoder: Decoder) =>
