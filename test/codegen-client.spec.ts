...
import { wrapModule } from "../src/codegen"
...
export function loadBookService(port: RpcClientPort): BookService {
  const builder = wrapModule<BookService>(port.loadModule("BookService"))
  builder.setMethodUnary("GetBook", GetBookRequest, Book)
  builder.setMethodStream("QueryBooks", QueryBooksRequest, Book)
